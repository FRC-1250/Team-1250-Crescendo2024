...
public class ShoulderConfig {
	...
	public static final String RIGHT_ROTATOR_STRING = "Right rotator";
	...
	private static final Slot0Configs MOTION_MAGIC_PID = new Slot0Configs()
			.withKS(0)
			.withKV(0)
			.withKA(0)
			.withKP(25)
